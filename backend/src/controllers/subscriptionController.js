...
const getMyPlan = async (req, res) => {
  try {
    ...
    // Verifica se subscrição Pro ainda está válida
...
// Calcula comissão num pagamento
...
// Resumo financeiro da plataforma (só admin)
const getPlatformRevenue = async (req, res) => {
  try {
    ...
    // Receita de comissões (5% dos pagamentos)
